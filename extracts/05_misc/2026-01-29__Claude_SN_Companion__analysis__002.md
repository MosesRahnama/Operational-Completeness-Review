Purpose: Evidence extract (misc/analysis) documenting a failure or relevance; Analysis write-up; not a proof artifact itself.
Contents: Metadata header + excerpt from the source file.
Context: Technical companion analysis of Claude_SN.lean with failure explanation.
Source: MUST_Review/MetaMD_Archive/Claude_SN_Companion.md
