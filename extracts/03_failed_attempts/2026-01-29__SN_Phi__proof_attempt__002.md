Purpose: Evidence extract (failed_attempts/proof-attempt) documenting a failure or relevance; The file contains an admit and relies on heavy automation (norm_num/linarith), so the ?-based SN proof is incomplete.
Contents: Metadata header + excerpt from the source file.
Context: Excerpt showing an admitted subgoal in the Φ-based rec_succ proof.
Source: MUST_Review/MetaMD_Archive/SN_Phi.md
