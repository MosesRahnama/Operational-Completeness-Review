Purpose: Evidence extract (failed_attempts/analysis) documenting a failure or relevance; Duplicate of FRV2-0400.
Contents: Metadata header + excerpt from the source file.
Context: Chronology of termination attempts and blockers.
Source: MUST_Review/important_2/3.Termination_Consolidation copy.md
...
> ```lean
> // filepath: math_ops\OperatorKernelO6\OperatorKernelO6\Meta\Termination_Legacy.lean
