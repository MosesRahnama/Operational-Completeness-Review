Purpose: Evidence extract (failed_attempts/analysis) documenting a failure or relevance; Duplicate of MUST_Review\Legacy\Meta_Lean_Archive\SN_Opus.lean.
Contents: Metadata header + excerpt from the source file.
Context: SN_Opus.lean uses a double-exponent ordinal measure μ₂ and claims strict decrease for all rules.
Source: MUST_Review/Legacy/Meta_Lean_Archive/SN_Opus.lean
