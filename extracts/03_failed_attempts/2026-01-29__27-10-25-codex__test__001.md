Purpose: Evidence extract (failed_attempts/chat) documenting a failure or relevance; Feasibility response without concrete proof obligations.
Contents: Metadata header + excerpt from the source file.
Context: Feasibility response without concrete proof obligations.
Source: MUST_Review/chats/tests/27-10-25-codex-.md
